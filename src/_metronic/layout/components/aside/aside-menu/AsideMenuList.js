      ...
      <ul className={`menu-nav ${layoutProps.ulClasses}`}>
            ...
            <ul className="menu-subnav">
              ...
              >
                ...
                >
                  ...
                  <span className="menu-text">Players Profiles</span>
                  <i className="menu-arrow" />
                </NavLink>
              </li>
              <li
              ...
              >
                <NavLink
                  className="menu-link menu-toggle"
                  to="/profiles/sponsors"
                >
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">Sponsors Profiles</span>
                  <i className="menu-arrow" />
                </NavLink>
              </li>
            </ul>
        ...
        >
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              {/* <li className="menu-item  menu-item-parent" aria-haspopup="true">
                <span className="menu-link">
                  <span className="menu-text">Upcoming Tournaments</span>
                </span>
              </li> */}
              ...
              >
                ...
                >
                  ...
                  <span className="menu-text">Completed Tournamets</span>
                  <i className="menu-arrow" />
                </NavLink>
              </li>
            </ul>
            ...
            <ul className="menu-subnav">
              ...
              >
                <NavLink className="menu-link menu-toggle" to="/networks/all">
                  ...
                  <span className="menu-text">All Networks</span>
                  <i className="menu-arrow" />
                </NavLink>
              </li>
              <li
                ...
                data-menu-toggle="hover"
              >
                <NavLink className="menu-link menu-toggle" to="/networks/new">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">Add New Network</span>
                  <i className="menu-arrow" />
                </NavLink>
              </li>
            </ul>
        ...
        >
          <NavLink className="menu-link menu-toggle" to="/networks/all">
            ...
            <span className="menu-text">Common Pages</span>
            <i className="menu-arrow" />
          </NavLink>
          <div className="menu-submenu ">
            <i className="menu-arrow" />
            <ul className="menu-subnav">
              ...
              <li
                ...
                data-menu-toggle="hover"
              >
                <NavLink className="menu-link menu-toggle" to="/pages/all">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
              ...
              <li
                ...
                data-menu-toggle="hover"
              >
                <NavLink className="menu-link menu-toggle" to="/pages/new">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
        ...
        <li
          ...
          data-menu-toggle="hover"
        >
          <NavLink className="menu-link menu-toggle" to="/banners/all">
            <span className="svg-icon menu-icon">
              <SVG src={toAbsoluteUrl("/media/svg/icons/Design/Cap-2.svg")} />
            </span>
            ...
            <ul className="menu-subnav">
              ...
              >
                <NavLink className="menu-link menu-toggle" to="/banners/all">
                  ...
                  <span className="menu-text">All Banners</span>
                  <i className="menu-arrow" />
                </NavLink>
              </li>
              <li
                ...
                data-menu-toggle="hover"
              >
                <NavLink className="menu-link menu-toggle" to="/banners/new">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">Add New Banner</span>
                  <i className="menu-arrow" />
                </NavLink>
              </li>
            </ul>
            ...
            <ul className="menu-subnav">
              ...
              >
                ...
                >
                  ...
                  <span className="menu-text">Add New Plan</span>
                  <i className="menu-arrow" />
                </NavLink>
              </li>
            </ul>
