...
export default function CustomTableForNetworks({ data }) {
      ...
      <Table className={classes.table}>
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">Page Content</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {data.map((row) => (
            <StyledTableRow key={row.name}>
              ...
              <StyledTableCell align="right">/{row.page_slug}</StyledTableCell>
